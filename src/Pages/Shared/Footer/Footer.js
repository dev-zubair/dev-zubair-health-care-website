            ...
            <Container>
                <Row>
                    <Col md={3}>
                        <div>
                            ...
                            <ul className="list-unstyled text-white mt-3 m">
                                ...
                                <li style={{ color: "#396CF0" }} className="list-unstyled fs-4 mb-2 mt-3 fw-bolder text-center">Follow Us</li>
                    ...
                    <Col md={3}>
                        <div>
                            <ul className="list-unstyled mt-3 footer-link">
                                <li style={{ color: "#396CF0" }} className="list-unstyled fs-4 mb-2 mt-3 fw-bolder">Quick Links</li>
                    ...
                    <Col md={3}>
                        <div>
                            <li style={{ color: "#396CF0" }} className="list-unstyled fs-4 mb-2 mt-3 fw-bolder">Opening Hours</li>
